...
<script>
  ...
  if (storedName && storedName.toLowerCase() === 'ghostwebsite') {
   
  } else {
    const name = window.prompt(message);
    if (name && name.toLowerCase() === 'ghostwebsite') {
					...
					<div class="col-md-8">
						<div class="card">
							<div class="card-body text-center anime">
								...
								<span> </span>
								<span> </span>
								<h4 class="mb-2"><strong>SK Rate Limit Bypass + Non SK Checker</strong></h4>

								<textarea rows="16" id="lista" class="form-control text-center form-checker mb-2" placeholder=""></textarea>
								...
								<textarea rows="1" class="form-control text-center" style="width: 30%; float: right; margin-bottom: 5px; resize:none; overflow:hidden;" id="cst" placeholder="CUSTOM"></textarea></br>
								<select name="gate" id="gate" class="form-control" style="margin-bottom: 5px; text-align:center" <option </option>


									<option style="background:rgba(16, 15, 154, 0.281);color:rgb(25, 208, 1);color:white" value="gate/api1.php">API 1 : Non SK (Membership Site)</option>

									<option style="background:rgba(16, 15, 154, 0.281);color:rgb(25, 208, 1);color:white" value="gate/api2.php">API 2 : Non SK (Membership Site)</option>

									<option style="background:rgba(16, 15, 154, 0.281);color:rgb(25, 208, 1);color:white" value="gate/api3.php">API 3 : Non SK (Membership Site)(Offline)</option>

									<option style="background:rgba(16, 15, 154, 0.281);color:rgb(25, 208, 1);color:white" value="gate/api4.php">API 4 : Non SK (Membership Site)(Offline)</option>

									<option style="background:rgba(16, 15, 154, 0.281);color:rgb(25, 208, 1);color:white" value="gate/api5.php">API 5 : Non SK (Donation Site)(Offline)</option>

									<option style="background:rgba(16, 15, 154, 0.281);color:rgb(255, 208, 0);color:white" value="gate/usd1CCN.php">SK CCN Charged : $1</option>

									<option style="background:rgba(16, 15, 154, 0.281);color:rgb(255, 208, 0);color:white" value="gate/usd5CCN.php">SK CCN Charged : $5</option>

									<option style="background:rgba(16, 15, 154, 0.281);color:rgb(25, 208, 1);color:white" value="gate/eur1CCN.php">SK CCN Charged : €1</option>

									<option style="background:rgba(16, 15, 154, 0.281);color:rgb(25, 208, 1);color:white" value="gate/eur5CCN.php">SK CCN Charged : €5</option>

									<option style="background:rgba(16, 15, 154, 0.281);color:rgb(255, 208, 0);color:white" value="gate/usd1CVV.php">SK CVV Charged : $1</option>

									<option style="background:rgba(16, 15, 154, 0.281);color:rgb(255, 208, 0);color:white" value="gate/usd5CVV.php">SK CVV Charged : $5</option>

									<option style="background:rgba(16, 15, 154, 0.281);color:rgb(25, 208, 1);color:white" value="gate/eur1CVV.php">SK CVV Charged : €1</option>

									<option style="background:rgba(16, 15, 154, 0.281);color:rgb(25, 208, 1);color:white" value="gate/eur5CVV.php">SK CVV Charged : €5</option>
						...
						<div class="">
							...
							<div class="card mb-2">
								<div class="card-body" style="padding:0.9rem;">
									...
									<div style="position:absolute; left: 37%; top: -3%;">CC Auto Generator</div>	<form name="console" id="console" role="form" method="POST" class="snipcss0-1-1-6">
											...
											<div class="snipcss0-2-6-7">
													...
													<div class="col-8 col-lg-8 snipcss0-4-8-9">
														<div class="form-group snipcss0-5-9-10">
															...
															<center class="snipcss0-7-11-13">
																<input id="ccpN" name="ccp" maxlength="19" type="text" class="form-control snipcss0-8-13-14 style-cg7tQ" placeholder="45359xx">
															</center>
															</center>
														</div>
													</div>
												...
												<div class="row snipcss0-3-7-21">
													<div class="col-4 col-lg-4 snipcss0-4-21-22">
														<div class="form-group snipcss0-5-22-23">
															...
															<div type="hidden" id="bininfo" align="center" class="snipcss0-6-23-31">
															</div>
													...
													<div class="col-4 col-lg-4 snipcss0-4-21-67">
														<div class="form-group snipcss0-5-67-68">
															...
															<center class="snipcss0-7-69-71">
																<input type="number" name="ccghm" maxlength="4" class="form-control snipcss0-8-71-72 style-HH1RW" value="100" id="style-HH1RW">
												...
												<div class="row snipcss0-3-7-75">
													<button type="button" class="btn btn-outline-light block shadow-none snipcss0-4-75-76 style-eVS8h" name="gerar" id="gerar" data-dismiss="modal" onclick="playClick();">
														GENERATE
													</button>
												</div>
						...
						<div class="card">
							<div class="card-body">
								...
								<center>
									...
									<h4 class="card-title mb-1"><i class="fa fa-check-circle text-success"></i> CHARGED
									</h4>
									<div id='lista_charge' class="center-fixed"></div>
							</div>
						</div>
					</div>
					<div class="col-xl-12">
						<div class="card">
							<div class="card-body">
								...
								<center>
									...
									<div id='lista_cvvs' class='center-fixed'></div>
							</div>
						</div>
					</div>
					<div class="col-xl-12">
						<div class="card">
							<div class="card-body">
								...
								<center>
									...
									<div id='lista_aprovadas' class='center-fixed'></div>
							</div>
						</div>
					</div>
					<div class="col-xl-12">
						<div class="card">
							<div class="card-body">
								...
								<center>
									...
									<div style='display: none;' id='lista_reprovadas' class='center-fixed'></div>
							</div>
						</div>
					</div>
