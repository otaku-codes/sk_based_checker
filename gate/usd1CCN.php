...
$charged_message = "Charged CC:$lista\r\n➤ Response:$amt\r\n➤ SK Key:$sk\r\n➤Success URL:" . urldecode($receipturl) . "";
...
elseif(strpos($result1, "testmode_charges_only" )) {
    echo '<font color=red><b>DEAD [ SK KEY DEAD OR INVALID ]<span style="color: rgb(0 255 0);  font-weight: bold"> [Re: ' . $x . ']</span><br><span style="color: #ff4747;  font-weight: bold; margin-bottom:3px;">'.$lista.'</span><br>';
}
